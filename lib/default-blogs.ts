import { BlogPost } from './blog-storage';

export const defaultBlogs: BlogPost[] = [
  {
    id: 1,
    title: "The Ultimate Safari Guide: Spotting Leopards in Yala National Park",
    excerpt: "Embark on an unforgettable safari adventure in Yala National Park, where nature's most elusive predator awaits. Discover the secrets of finding leopards in their natural habitat, including the best safari times, prime locations, and expert tips from our experienced safari guides.",
...
Remember that wildlife viewing requires patience and respect for nature's timing. While Yala offers exceptional leopard viewing opportunities, each safari is unique, and the experience of being in their natural habitat is valuable regardless of specific sightings.`,
  ...
  },
  {
    ...
    excerpt: "Experience the magic of an authentic safari adventure as you watch wild elephants roam freely in their natural habitat at Udawalawe. Immerse yourself in nature's grandeur at one of Sri Lanka's premier elephant viewing destinations, where every safari moment brings you closer to the wild heart of the island.",
...
The combination of international conservation significance, exceptional bird diversity, and unique coastal wetland ecosystems makes Bundala National Park an essential destination for birdwatchers and nature enthusiasts visiting Sri Lanka.`,
  ...
  },
  {
    ...
    excerpt: "Plan your perfect safari adventure with our comprehensive guide to the best seasons for experiencing nature's spectacle in each of Sri Lanka's national parks. Discover when wildlife is most active and nature's beauty reaches its peak.",
...
Work with experienced safari operators who understand seasonal patterns and can guide you to optimal viewing opportunities regardless of the time of year. The key is matching your interests—whether wildlife viewing, photography, or birdwatching—with the season that best supports those activities.`,
  ...
  },
  {
    ...
    excerpt: "Discover Lunugamwehera National Park on an exclusive safari adventure, a peaceful natural sanctuary offering excellent elephant viewing, diverse wildlife, and authentic wilderness experiences away from the crowds. Experience the untouched beauty of Sri Lanka's hidden safari gem.",
...
Lunugamwehera offers excellent viewing year-round, with the dry season (May-September) providing the most concentrated wildlife viewing as animals gather around water sources. The park's accessibility and peaceful atmosphere make it an ideal choice for first-time safari visitors or those seeking a more relaxed experience.`,
  ...
  },
  {
    ...
    excerpt: "Prepare for your ultimate safari adventure in Sri Lanka's wilderness with our essential packing guide. Discover everything you need for comfort, safety, and capturing nature's most spectacular moments during your wildlife safari experience.",
...
Proper preparation ensures you're ready to fully enjoy your safari adventure while staying comfortable and safe throughout your wildlife viewing experience.`,
  ...
  },
  {
    ...
    excerpt: "Learn about the diverse wildlife you'll encounter during your Sri Lankan safari adventure, including identification tips, behavioral insights, and the natural behaviors of key species thriving in their wild habitats.",
...
Understanding these animals' roles in their ecosystems deepens appreciation for the complex relationships that maintain healthy wildlife populations in Sri Lanka's national parks.`,
  ...
  },
  {
    ...
    excerpt: "Essential safety guidelines and responsible safari practices for enjoying nature's wonders while protecting wildlife and ensuring your safety during national park visits. Learn how to experience the wild respectfully.",
...
Following these guidelines ensures safe, enjoyable safaris while protecting the incredible wildlife that makes Sri Lanka's national parks so special.`,
  ...
  },
  {
    ...
    excerpt: "Expert insights into the best safari routes within Sri Lanka's national parks, including timing strategies and route selection for optimal wildlife viewing. Discover nature's hidden pathways for unforgettable safari experiences.",
