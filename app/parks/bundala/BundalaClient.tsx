  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/Images/bubig.webp')",
        }}
      >
      ...
      >
        ...
        <div className="w-full flex lg:flex-row flex-col-reverse gap-2 md:gap-3 lg:gap-4 xl:gap-6">
          ...
          >
            ...
            <p>
              Whether you&apos;re a birder, nature photographer, or someone
              seeking a peaceful safari experience away from the crowds, Bundala
              promises rare and remarkable moments in the wild.
            </p>
          </div>
        </div>
        ...
        <div className="w-full flex lg:flex-row flex-col-reverse gap-2 md:gap-3 lg:gap-4 xl:gap-6">
          ...
          >
            <p className="items-center">
              ...
              {""}
              It’s one of the few parks in the world where you can witness the
              delicate dance of {""}
              <span className="text-accent font-bold">
                flamingos against the backdrop of the Indian Ocean.{" "}
              </span>
              {""}With its rich biodiversity and ecological importance, Bundala
              offers a gentler, quieter, yet deeply rewarding safari experience
              like no other.
              <br />
              &quot;Bundala National Park is a fantastic maze of waterways,
              lagoons and dunes that glitter like gold in the dying evening
              sun&quot;
              <span>
                <Link
                  className="bg-[#D9FFE2] border border-black text-xs rounded-full font-light italic py-2 px-4"
                  href={
                    "https://www.lonelyplanet.com/sri-lanka/the-south/bundala-national-park/attractions/bundala-national-park/a/poi-sig/1194743/357485"
                  }
                  target="blank"
                >
                  *lonelyplanet.com
      ...
      <Gallery title="Bundala" images={images} />
      <Features packageName="Bundala National Park" />
    </>
  );
};

export default BundalaClient;
